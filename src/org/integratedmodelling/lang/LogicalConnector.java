...
public class LogicalConnector {
     ...
     */
    public static LogicalConnector parseLogicalConnector(String s) throws ThinklabValidationException {
        ...
        if (s.equals("and") || s.equals("intersection"))
           ...
           throw new ThinklabValidationException(s + " is not a valid logical connector");
     ...
     */
    public boolean equals(String s) throws ThinklabValidationException {
