...
public interface IMediatingAccessor  {
	...
	/**
	 * Receive an observer to mediate from and ensure it is compatible with our semantics. Note that
	 ...
	 */
	public abstract void notifyMediation(IObserver observer) throws ThinklabException;
